    ...
    <div class="page-content">
      ...
      <div style="padding:36px 0;">
        <form class="form-inline" id="search">
          ...
          <div class="form-group">
            <label>品牌：</label>
            <select name="partsType" class="form-control"
...
<script type="text/javascript">
  ...
  jQuery(function ($) {
    ...
    $(grid_selector).jqGrid({
      url: "parts/parts-oil-list",
      mtype: "POST",
      datatype: "json",
      height: 620,
      colNames: ['配件编号', '配件中文名', '配件英文名', '价格', '配件类型'],
      colModel: [
        {name: 'partsid', index: 'partsid', autowidth: true, align: "center"},
        {name: 'name_en', index: 'name_en', autowidth: true, align: "left"},
        {name: 'name', index: 'name', autowidth: true, align: "left"},
