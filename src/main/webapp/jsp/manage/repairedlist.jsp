    ...
    <div class="page-content">
      ...
      <div style="padding:36px 0;">
        <form class="form-inline" id="search">
          ...
          <div class="form-group">
            <label>车系：</label>
            <select name="series" id="carSeries" class="form-control">
              <option value="">选择车系</option>
            </select>
          </div>
          <div class="form-group">
            <label>行驶公里数：</label>
            <input type="text" name="mile" class="form-control"
                   placeholder="行驶公里数">公里
          </div>
          <div class="input-group date"  id="datepicker" data-date-format="yyyy-mm-dd">
            <input type="text" name="time" aclass="form-control"
...
<script src="static/ace/js/date-time/locales/bootstrap-datepicker.zh-CN.js"></script>
...
<script type="text/javascript">
  ...
  jQuery(function ($) {
    ...
    $(grid_selector).jqGrid({
      ...
      datatype: "json",
      height: 620,
      colNames: ['品牌', '车系', '维护操作', '操作周期', '操作类型', '配件类型'],
      colModel: [
        {name: 'brand', index: 'brand', autowidth: true, align: "center"},
        {name: 'series', index: 'series', autowidth: true, align: "center"},
        {name: 'operation', index: 'partsid', autowidth: true, align: "center"},
        {name: 'frequency', index: 'name', autowidth: true, align: "center"},
        {name: 'type', index: 'type', autowidth: true, align: "center"},
        {name: 'parts_type', index: 'price', autowidth: true, align: "center"}
      ],
    ...
    jQuery(grid_selector).jqGrid('navGrid', pager_selector,
      ...
      onClickButton: function () {
        window.location.href = "<%=basePath%>repaired/download"
      },
      position: "first",
